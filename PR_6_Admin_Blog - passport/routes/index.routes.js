...
const { dashboardpage, loginPage, loginUser, logoutUser, changePasswordPage, changePassword, forgotPasswordPage, sendOTP, verfiyOTPPage, updatePasswordPage, verifyOTP, updatePassword,profilePage  } = require('../controllers/index.controller');
